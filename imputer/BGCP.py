...
input_mat_path = '../datasets/Guangzhou-data-setMitMissingValue/sparse_tensor.mat'
output_dir = './Guangzhou-data-setImputed'
output_mat_path = os.path.join(output_dir, 'Imputed_tensor.mat')
output_log_path = os.path.join(output_dir, 'BGCP_log.txt')
os.makedirs(output_dir, exist_ok=True)
sparse_tensor = scipy.io.loadmat(input_mat_path)['tensor']
...
burn_iter = 1000
gibbs_iter = 200
tensor_hat, factor = BGCP(dense_tensor, sparse_tensor, factor, burn_iter, gibbs_iter, output_log_path)
scipy.io.savemat(output_mat_path, {'tensor': tensor_hat})
end = time.time()
